...
<body class="bg-dark text-success text-center">
    ...
    <div class="container mt-5">
     <form action="idFindAction.jsp" method="post" class="mt-3">
  <div class="form-group">
    <label for="email" class="col-2">ID 찾기</label><br>
    <input type="email" class="form-control-lg col-4" id="email" name="email" placeholder="email을 입력해주세요">
  </div>
  <button type="submit" class="btn btn-success btn-lg">ID 찾기</button>
</form> 
</div>
<%
