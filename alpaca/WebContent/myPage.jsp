...
<body class="bg-dark text-success text-center">
    ...
    <div class="row">
        ...
        if(request.getParameter("my")==null){
            ...
            <form action="myPageCheck.jsp" method="post" class="mt-3">
                <div class="form-group">
                    <label for="password" class="col-2">비밀번호를 입력해 주세요.</label><br><input type="password" name="password" id="password" class="form-control-lg col-4">
                </div>
                <br>
                    <button type="submit" class="btn btn-success btn-lg">정보수정</button>
            </form>
        </div>
        	<%
        }else if(request.getParameter("my")!=null){
        	int num = Integer.parseInt(request.getParameter("my"));
        	if(num==1){
        		%>
        		<div class="container mt-5">
